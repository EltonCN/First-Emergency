...
namespace MyUnityScripts
{
    ...
    {
        [MenuItem("Tools/My Unity Scripts/Reveal Hidden GameObjects")]
        ...
        [MenuItem("Tools/My Unity Scripts/Reveal Hidden GameObjects", true)]
		public static bool RevealHiddenGameObjectsValidator()
		{
